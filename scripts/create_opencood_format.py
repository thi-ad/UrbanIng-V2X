...
def main():
    ...
    target_opencood_folder = r"/path/to/target/dir"
    ...
    sequences = [os.path.splitext(sequence)[0] for sequence in sequences]  # remove file extension
    os.makedirs(target_opencood_folder, exist_ok=True)

    args = [[sequence, root_folder, labels_folder, target_opencood_folder] for sequence in sequences]
