...
class LidarEarlyFusionVisDataset(basedataset.BaseDataset):
    def __init__(self, params, visualize=False, train=True, **kwargs):
        super(LidarEarlyFusionVisDataset, self).__init__(params, visualize, train, **kwargs)
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # save lidar_np to disk
        # np.save('lidar_np.npy', lidar_np)
