...
class LidarEarlyFusionDataset(basedataset.BaseDataset):
    """
    ...
    def __init__(self, params, visualize=False, train=True, **kwargs):
        super(LidarEarlyFusionDataset, self).__init__(params, visualize, train, **kwargs)
    ...
    def __getitem__(self, idx):
        ...
        if self.visualize:
            ...
            for projected_lidar in projected_lidar_list:
                projected_lidar = mask_points_by_range(projected_lidar, self.gt_range)
