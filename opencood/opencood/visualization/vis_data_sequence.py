...
from opencood.data_utils.datasets.lidar.early_fusion_vis_dataset import \
    LidarEarlyFusionVisDataset
...
if __name__ == '__main__':
    ...
    params = load_yaml(os.path.join(current_path,
                                    '../hypes_yaml/<placeholder>.yaml'))

    opencda_dataset = LidarEarlyFusionVisDataset(params, visualize=True, train=False)
